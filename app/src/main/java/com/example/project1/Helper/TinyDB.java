...
public class TinyDB {
    ...
    public ArrayList<DrinksCoffee> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<DrinksCoffee> playerList =  new ArrayList<DrinksCoffee>();

        for(String jObjString : objStrings){
            DrinksCoffee player  = gson.fromJson(jObjString,  DrinksCoffee.class);
    ...
    public void putListObject(String key, ArrayList<DrinksCoffee> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(DrinksCoffee player: playerList){
